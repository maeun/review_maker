...
import { FaEnvelope, FaGithub, FaGlobe, FaQuestionCircle } from "react-icons/fa";
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Review Maker 서비스에 대한 문의사항이나 지원이 필요하시면 언제든지 연락해주세요." />
              ...
              <VStack spacing={6} align="stretch">
                <VStack spacing={4} textAlign="center">
                  ...
                  <Text fontSize="lg" color="gray.600">
                    Review Maker 서비스에 대한 문의사항이나 지원이 필요하시면 언제든지 연락해주세요.
                  </Text>
                </VStack>

                <VStack spacing={6} align="stretch">
                  <Box>
                    <Heading size="md" mb={4}>📧 이메일 문의</Heading>
                    <Box bg={featureBg} p={4} borderRadius="lg">
                      <HStack spacing={3} mb={2}>
                        <Icon as={FaEnvelope} color="teal.500" />
                        <Text fontWeight="medium">일반 문의</Text>
                      </HStack>
                      <Text color="gray.600" mb={2}>
                        서비스 이용 문의, 협업/협찬, 기능 개선 제안, 버그 신고 등
                      </Text>
                      <Link href="mailto:contact@reviewmaker.com" color="teal.500" fontWeight="medium">
                        contact@reviewmaker.com
                      </Link>
                    </Box>
                  </Box>
                  ...
                  <Box>
                    ...
                    <VStack spacing={3} align="stretch">
                      ...
                      <Box bg={featureBg} p={4} borderRadius="lg">
                        ...
                        <Text color="gray.600">
                          네, 생성된 리뷰의 저작권은 이용자에게 있어 자유롭게 활용하실 수 있습니다. 단, 사용에 따른 책임은 이용자에게 있습니다.
                        </Text>
                      </Box>
                    </VStack>
                  </Box>
